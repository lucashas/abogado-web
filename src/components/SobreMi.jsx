        ...
        <div className="col-md-8">
          <div className="testimonial-box">
            ...
            <p
              ...
              style={{ color: "var(--color-text)" }}
            >
              Creo firmemente que cada caso merece atención personalizada,
              transparencia y acompañamiento constante. Mi objetivo es defender
              tus derechos y ayudarte a tomar decisiones informadas.
            </p>
          </div>
        </div>
      </div>
